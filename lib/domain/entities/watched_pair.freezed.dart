...
mixin _$WatchedPair {
 ...
 String get pairKey; String get baseCurrency; String get quoteCurrency; DateTime get createdAt;/// 绝对值上沿：最新汇率 ≥ 此值触发 RATE_ALERT（kind=high）。
...
@override
int get hashCode => Object.hash(runtimeType,pairKey,baseCurrency,quoteCurrency,createdAt,thresholdHigh,thresholdLow,alertChangePct);

@override
String toString() {
  return 'WatchedPair(pairKey: $pairKey, baseCurrency: $baseCurrency, quoteCurrency: $quoteCurrency, createdAt: $createdAt, thresholdHigh: $thresholdHigh, thresholdLow: $thresholdLow, alertChangePct: $alertChangePct)';
}
...
@useResult
$Res call({
 String pairKey, String baseCurrency, String quoteCurrency, DateTime createdAt, Decimal? thresholdHigh, Decimal? thresholdLow, Decimal? alertChangePct
});
...
/// Create a copy of WatchedPair
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pairKey = null,Object? baseCurrency = null,Object? quoteCurrency = null,Object? createdAt = null,Object? thresholdHigh = freezed,Object? thresholdLow = freezed,Object? alertChangePct = freezed,}) {
...
as DateTime,thresholdHigh: freezed == thresholdHigh ? _self.thresholdHigh : thresholdHigh // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String pairKey,  String baseCurrency,  String quoteCurrency,  DateTime createdAt,  Decimal? thresholdHigh,  Decimal? thresholdLow,  Decimal? alertChangePct)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WatchedPair() when $default != null:
return $default(_that.pairKey,_that.baseCurrency,_that.quoteCurrency,_that.createdAt,_that.thresholdHigh,_that.thresholdLow,_that.alertChangePct);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String pairKey,  String baseCurrency,  String quoteCurrency,  DateTime createdAt,  Decimal? thresholdHigh,  Decimal? thresholdLow,  Decimal? alertChangePct)  $default,) {final _that = this;
switch (_that) {
case _WatchedPair():
return $default(_that.pairKey,_that.baseCurrency,_that.quoteCurrency,_that.createdAt,_that.thresholdHigh,_that.thresholdLow,_that.alertChangePct);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String pairKey,  String baseCurrency,  String quoteCurrency,  DateTime createdAt,  Decimal? thresholdHigh,  Decimal? thresholdLow,  Decimal? alertChangePct)?  $default,) {final _that = this;
switch (_that) {
case _WatchedPair() when $default != null:
return $default(_that.pairKey,_that.baseCurrency,_that.quoteCurrency,_that.createdAt,_that.thresholdHigh,_that.thresholdLow,_that.alertChangePct);case _:
  return null;
...
class _WatchedPair extends WatchedPair {
  const _WatchedPair({required this.pairKey, required this.baseCurrency, required this.quoteCurrency, required this.createdAt, this.thresholdHigh, this.thresholdLow, this.alertChangePct}): super._();
...
/// Create a copy of WatchedPair
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pairKey = null,Object? baseCurrency = null,Object? quoteCurrency = null,Object? createdAt = null,Object? thresholdHigh = freezed,Object? thresholdLow = freezed,Object? alertChangePct = freezed,}) {
